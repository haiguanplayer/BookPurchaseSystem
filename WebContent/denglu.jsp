...
<h1>Login</h1>
	<form action="UsersLoginServlet" method="post">
			<input type="text" required="required" placeholder="用户名" name="u_id" id="u_name" onblur="checkName()" onfocus="focusName(this)"></input>
			<td><div id="name_msg">用户名必须为9位</div></td>   
            <input type="password" required="required" placeholder="密码" name="u_password" id="pwd" onfocus="focusPwd(this)" onblur="checkPwd()"></input>
