...
/**
 * Servlet implementation class changeusersmeSverlet
 */
@WebServlet("/changeusersmeSverlet")
public class changeusersmeSverlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public changeusersmeSverlet() {
        super();
